...
Single Project File: Adds a new project or prompts to overwrite an existing one with the same ID.

Full Backup File: Restores all projects and application settings from an "Export All" backup.
